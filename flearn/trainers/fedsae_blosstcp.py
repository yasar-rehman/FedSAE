...
class Server(BaseFedarated):
    ...
    def train(self):
        ...
        self.write_data_to_file(trainer="fedsae_correctblosstcp", str_dataset="mnist", distribution="normal_σ=ran(0.25μ_0.5μ)", file_name="mnist_softmaxloss_a0.01_tcp_30c_200r_CNN", test_acc=test_acc, train_acc=train_acc, loss=loss, drop_out_percentage = drop_out_percentage, selected_times=selected_times)
        self.get_result(trainer="fedsae_correctblosstcp", str_dataset="mnist", distribution="normal_σ=ran(0.25μ_0.5μ)", file_name="mnist_softmaxloss_a0.01_tcp_30c_200r_CNN")

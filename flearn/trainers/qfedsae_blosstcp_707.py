...
class Server(BaseFedarated):
    ...
    def train(self):
        ...
        for i in range(self.num_rounds):
            ...
            #self.latest_model = self.aggregate(csolns)   #原聚合函数
        ...
        self.write_data_to_file(trainer="fedsae_correctblosstcp", str_dataset="mnist", distribution="normal_σ=ran(0.25μ_0.5μ)", file_name="mnist_q0.1tcp+class6_30c_200r_mclr", test_acc=test_acc, train_acc=train_acc, loss=loss, drop_out_percentage = drop_out_percentage, selected_times=selected_times, test_acc_variance=test_acc_variance, train_acc_variance=train_acc_variance)
        self.get_result(trainer="fedsae_correctblosstcp", str_dataset="mnist", distribution="normal_σ=ran(0.25μ_0.5μ)", file_name="mnist_q0.1tcp+class6_30c_200r_mclr")

...
class Server(BaseFedarated):
    ...
    def train(self):
        ...
        self.write_data_to_file0(trainer="fedavg", str_dataset="mnist", distribution="fixed_normal_distribution", file_name="mnist_fedavg_fixed_normal_epoch_10_c30_200r_mclr", test_acc=test_acc, train_acc=train_acc, loss=loss, drop_out_percentage = drop_out_percentage, test_acc_variance=test_acc_variance, train_acc_variance=train_acc_variance)
        self.get_result0(trainer="fedavg", str_dataset="mnist", distribution="fixed_normal_distribution", file_name="mnist_fedavg_fixed_normal_epoch_10_c30_200r_mclr")

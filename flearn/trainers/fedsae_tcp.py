...
class Server(BaseFedarated):
    ...
    def train(self):
        ...
        self.write_data_to_file(trainer="fedsae", str_dataset="synthetic1_1", distribution="normal_σ=ran(0.25μ_0.5μ)", file_name="synthetic1_1_tcp_k10_c100", test_acc=test_acc, train_acc=train_acc, loss=loss, drop_out_percentage = drop_out_percentage, selected_times=selected_times)
        self.get_result(trainer="fedsae", str_dataset="synthetic1_1", distribution="normal_σ=ran(0.25μ_0.5μ)", file_name="synthetic1_1_tcp_k10_c100")

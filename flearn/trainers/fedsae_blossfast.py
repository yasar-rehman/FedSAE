...
class Server(BaseFedarated):
    ...
    def train(self):
        ...
        self.write_data_to_file(trainer="fedsae_correctblossfast", str_dataset="mnist", distribution="normal_σ=ran(0.25μ_0.5μ)", file_name="mnist_d13_d21_a0.95_fast_c30_200r_CNN", test_acc=test_acc, train_acc=train_acc, loss=loss, drop_out_percentage = drop_out_percentage, selected_times=selected_times)
        self.get_result(trainer="fedsae_correctblossfast", str_dataset="mnist", distribution="normal_σ=ran(0.25μ_0.5μ)", file_name="mnist_d13_d21_a0.95_fast_c30_200r_CNN")

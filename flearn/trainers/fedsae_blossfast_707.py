...
class Server(BaseFedarated):
    ...
    def train(self):
        ...
        self.write_data_to_file(trainer="fedsae_correctblossfast", str_dataset="fmnist", distribution="poisson_distribution", file_name="fmnist_fedsae_blossfast_random_select_mu10_c10_300r_mclr", test_acc=test_acc, train_acc=train_acc, loss=loss, drop_out_percentage = drop_out_percentage, selected_times=selected_times, test_acc_variance=test_acc_variance, train_acc_variance=train_acc_variance)
        self.get_result(trainer="fedsae_correctblossfast", str_dataset="fmnist", distribution="poisson_distribution", file_name="fmnist_fedsae_blossfast_random_select_mu10_c10_300r_mclr")

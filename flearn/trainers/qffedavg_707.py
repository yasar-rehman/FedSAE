...
class Server(BaseFedarated):
    ...
    def train(self):
        ...
        self.write_data_to_file0(trainer="fedavg", str_dataset="fmnist", distribution="normal_σ=ran(0.25μ_0.5μ)", file_name="fmnist_qffedavg0.1_num_epoch_15_c10_300r_mclr_220104", test_acc=test_acc, train_acc=train_acc, loss=loss, drop_out_percentage = drop_out_percentage, test_acc_variance=test_acc_variance, train_acc_variance=train_acc_variance)
        self.get_result0(trainer="fedavg", str_dataset="fmnist", distribution="normal_σ=ran(0.25μ_0.5μ)", file_name="fmnist_qffedavg0.1_num_epoch_15_c10_300r_mclr_220104")
